...
/* Extracted from libsodium with slight modifications for use in this implementation, 
 * source available at https://download.libsodium.org/doc/ 
 * Libsodium v1.0.18 Retrieved 13 Feb 2019
 */
