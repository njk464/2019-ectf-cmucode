...
qemu-system-aarch64 -M arm-generic-fdt-7series -machine linux=on -serial stdio -display none -kernel /home/vagrant/MES/Arty-Z7-10/images/linux/u-boot.elf -dtb /home/vagrant/MES/Arty-Z7-10/images/linux/system.dtb -drive file=./sdcard.img,if=sd,format=raw -device loader,file=/home/vagrant/MES/Arty-Z7-10/images/linux/image.ub,addr=0x10000000 
